...
class DataFrame(Dataset):
    ...
    def __getitem__(self, index):
        return self.source_ids[index][:self.max_len], self.target_ids[index], self.state_nodes[index], self.state_adjs[index]
...
def collate_fn(data):
    source_ids, target_ids, state_nodes, state_adjs = zip(*data)
